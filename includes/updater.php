<?php
/* Load Class. */
$fxUpdater_comopressreleases_Updater = new fxUpdater_comopressreleases_Updater();
/**
 * Updater Class
**/
class fxUpdater_comopressreleases_Updater{
	/**
	 * Class Constructor
	 */
	public function __construct() {
		...
		$this->config = array(
			...
			'type'    => 'plugin',
			'id'      => 'como-press-releases/como-press-releases.php',
			'api'     => '1.0.5',
			'post'    => array(),
		);
		/* Admin Init */
